...
#define DLY_US(n)	__delay_cycles(n)
...
#define	CS_H()		(P1OUT |= SD_CS)	/* Set MMC CS "high" */
#define CS_L()		(P1OUT &= ~SD_CS)	/* Set MMC CS "low" */
#define CK_H()		(P1OUT |= SD_SCLK)	/* Set MMC SCLK "high" */
#define	CK_L()		(P1OUT &= ~SD_SCLK)	/* Set MMC SCLK "low" */
#define DI_H()		(P1OUT |= SD_DI)	/* Set MMC DI "high" */
#define DI_L()		(P1OUT &= ~SD_DI)	/* Set MMC DI "low" */
#define DO			(P1IN & SD_DO)		/* Get MMC DO value (high:true, low:false) */
...
DSTATUS disk_initialize (void)
{
	...
	ty = 0;
    r0 = send_cmd(CMD0, 0);
//    LCD_WriteString(0,1,"R_cmd0:"); 
//    LCD_WriteChar(48,1, r0/10+0x30);
//    LCD_WriteChar(54,1, r0%10+0x30); 
	if (r0 == 1) {			/* Enter Idle state */
    ...
    /** check card type ***/
//    LCD_WriteString(0,2,"Card:"); 
//    LCD_WriteChar(30,2, CardType/10+0x30);
//    LCD_WriteChar(36,2, CardType%10+0x30);   
